...
const bearerPassport = require('./../../validations/passport').bearer
...
// Returns headers for a specific file. It must be declared before any get route with the same signature.
...
// Creates a new file
router.post('/', bearerPassport, fileCtrl.add)
