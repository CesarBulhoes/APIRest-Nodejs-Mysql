...
const localPassport = require('./../validations/passport').local
...
router.post('/login', localPassport, userCtrl.login) 
...
// Creates a new user
router.post('/', validator.password, checkErrors, userCtrl.add) 
